...
const HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    content: "The manifold's geometric representation of negation is structurally inadequate to the logical and dialectical weight that negation carries. Natural-language negation in the geometry is likely a small rotation in a few dimensions (an orthogonality) rather than a global inversion, meaning a claim and its negation share most of their geometric coordinates and differ in only a small subspace. The result is that 'this policy is fair' and 'this policy is not fair' often have cosine similarity above 0.9. The deficit is not that the manifold has zero capacity for negation — it is that the capacity is geometrically trivial relative to the conceptual work negation performs. In logic, negation inverts the truth value entirely. In dialectics, negation is the motor of the argument. In the manifold, negation is a minor perturbation of an otherwise stable coordinate.",
  },
  {
