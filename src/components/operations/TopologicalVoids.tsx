...
const TOPOLOGY_PRESETS: Array<{ label: string; concepts: string[] }> = [
  ...
  },
  {
    ...
    concepts: [
      ...
      "Instrumental reason reduces all thought to the calculation of means for predetermined ends",
      "The technological system tends toward autonomy and resists democratic control",
      "Affordances are the possibilities for action that an artefact offers to its users",
      "Technical mediation transforms both the subject who uses a tool and the object it is applied to",
      "The pharmakon is simultaneously remedy and poison depending on how it is administered",
      "Algorithmic governance replaces deliberation with automated decision-making at scale",
      "Technics precede and constitute the human rather than being secondary additions to a pre-existing nature",
      "The attention economy captures human cognition as a resource to be monetised through design",
      "Planned obsolescence ensures perpetual consumption by designing artefacts to fail",
      "The stack is the planetary-scale computational infrastructure that reorganises sovereignty and territory",
      "Proletarianisation of knowledge occurs when cognitive capacities are externalised into technical systems",
      "The digital pharmakon can either destroy or cultivate attention depending on its design and use",
      "Critical making combines hands-on fabrication with theoretical reflection on technological conditions",
      "Surveillance capitalism extracts behavioural surplus from human experience and sells predictions of future behaviour",
      "The ban-opticon selectively excludes and includes populations through automated risk profiling",
      "Technological determinism holds that technology drives social change independently of human intention",
      "Social construction of technology holds that the design and meaning of artefacts are shaped by social groups",
      "Post-phenomenology studies how technologies mediate the relationship between humans and their world",
    ],
  },
  {
    label: "Structuralism",
    concepts: [
      "Language is a system of differences in which meaning arises from relations between signs not from reference",
      "The structure is the underlying system of rules that governs the production of meaning in any domain",
      "The signifier and signified are arbitrarily connected by social convention not by natural resemblance",
      "Langue is the abstract system of language while parole is its concrete use in speech",
      "The phoneme is the smallest unit of sound that distinguishes meaning within a language",
      "Synchronic analysis examines a system at a single moment in time rather than tracing its historical development",
      "Binary oppositions organise meaning into contrasting pairs such as nature and culture or raw and cooked",
      "The deep structure underlies and generates the surface forms of cultural phenomena",
      "Myth is a system of signs that transforms history into nature by making the contingent appear necessary",
      "The narrative function is a recurring unit of action that can be identified across different stories",
      "Kinship systems are structured by rules of exchange that organise social relations",
      "The symbolic order is the system of language and law that structures human subjectivity",
      "Structural causality operates through the system as a whole rather than through isolated elements",
      "The episteme is the deep structure of knowledge that determines what can be thought in a given epoch",
      "The death of man is the displacement of the humanist subject by the anonymous operation of structures",
      "Bricolage is the construction of meaning from whatever materials happen to be available",
      "The zero degree of writing is the attempt to write without style in a neutral transparent prose",
      "Semiology is the general science of signs of which linguistics is only one part",
      "The code is the system of conventions that makes communication possible between sender and receiver",
      "Overdetermination means that any phenomenon is the product of multiple intersecting structural causes",
    ],
  },
  {
    label: "Post-structuralism",
    concepts: [
      "Differance is the play of difference and deferral that makes meaning possible but never fully present",
      "Deconstruction reads texts against their own metaphysical assumptions to reveal suppressed contradictions",
      "The subject is not the origin of meaning but is constituted through discourse and power relations",
      "Power is not held by anyone but circulates through networks of relations and produces the subjects it governs",
      "The text has no outside because there is no meaning that precedes or escapes textual mediation",
      "Genealogy traces the contingent historical conditions that produced what presents itself as natural and necessary",
      "The rhizome is a non-hierarchical model of thought that connects any point to any other point",
      "Deterritorialisation liberates flows of desire from their fixed social coding",
      "The simulacrum is a copy without an original that precedes and determines what counts as real",
      "Intertextuality means that every text is woven from citations and references to other texts",
      "The author is a function of discourse rather than its origin or guarantor of meaning",
      "Jouissance is the excessive pleasure that disrupts the symbolic order and exceeds rational comprehension",
      "The supplement is what is added to something supposedly complete, revealing the original incompleteness",
      "Biopower administers life and populations through regulatory mechanisms rather than sovereign force",
      "The event is a rupture that transforms the conditions of possibility for thought and action",
      "Dissemination is the scattering of meaning that resists gathering into a single interpretation",
      "The pharmakon is undecidably both remedy and poison, undermining the binary opposition between them",
      "Nomad thought moves across territories without being captured by the state apparatus",
      "The fold is the operation by which the outside is brought inside, constituting interiority from exteriority",
      "Micropolitics operates at the level of desire, affect, and everyday practice rather than institutional power",
    ],
  },
  {
    label: "Digital Humanities",
    concepts: [
      "Digital humanities applies computational methods to the study of cultural texts and artefacts",
      "Distant reading uses quantitative analysis of large corpora rather than close reading of individual texts",
      "Topic modelling discovers latent thematic structures across collections of documents",
      "Network analysis reveals the structure of relationships between entities in cultural and historical data",
      "Text mining extracts patterns and knowledge from unstructured textual sources at scale",
      "Cultural analytics applies data science to the study of visual culture, media, and creative expression",
      "The digital archive transforms how cultural memory is preserved, accessed, and interpreted",
      "Stylometry identifies authorship through the statistical analysis of writing style",
      "Geospatial humanities maps cultural phenomena onto geographic space to reveal spatial patterns",
      "Linked open data connects cultural datasets across institutions using shared standards and ontologies",
      "Minimal computing advocates for digital scholarship that works within constraints of access and resources",
      "Critical making combines the fabrication of digital tools with reflection on their epistemological implications",
      "The computational turn challenges humanistic methods by introducing quantitative reasoning into interpretive disciplines",
      "Data feminism examines how power operates in data science and advocates for more equitable practices",
      "Platform studies analyses how the technical design of platforms shapes cultural production and social interaction",
      "Algorithmic criticism uses computational methods not to replace but to augment humanistic interpretation",
      "Digital pedagogy transforms teaching through interactive, collaborative, and technology-mediated approaches",
      "The lab model brings experimental and collaborative practices from the sciences into humanistic research",
      "Fair data principles ensure that data is findable, accessible, interoperable, and reusable",
      "Infrastructure studies examines the material systems that underlie and enable digital scholarship",
    ],
  },
  {
    label: "Critical Code Studies",
    concepts: [
      "Code is a cultural text that can be read, interpreted, and critiqued using humanistic methods",
      "The executability of code distinguishes it from other forms of writing and demands new interpretive approaches",
      "Software studies examines the cultural significance of software as a medium that shapes contemporary life",
      "Platform studies analyses how the technical architecture of platforms constrains and enables cultural production",
      "Critical technical practice combines the building of systems with critical reflection on their implications",
      "Algorithmic accountability demands that automated decision systems be transparent and subject to scrutiny",
      "Code comments reveal the intentions, assumptions, and social context of software production",
      "Obfuscated code challenges the assumption that programs must be readable to be meaningful",
      "The code of law and the law of code are increasingly intertwined as regulation is implemented in software",
      "Glitch aesthetics embraces computational error as a creative and critical practice",
      "Version control systems preserve the history of software as a collaborative and contested cultural process",
      "API design shapes what is possible and what is foreclosed in the construction of digital systems",
      "Technical debt is the accumulated cost of expedient decisions that constrain future development",
      "Open source practice distributes the means of software production beyond corporate enclosures",
      "The command line interface reveals the operational logic that graphical interfaces are designed to conceal",
      "Pseudocode is the boundary between natural language and formal specification where human intent meets machine execution",
      "Legacy code carries the sedimented decisions of past developers into present systems",
      "Refactoring is the restructuring of code without changing its behaviour, revealing assumptions about good form",
      "The compiler translates human-readable code into machine-executable instructions, performing a material transformation",
      "Literate programming interweaves code and commentary to produce programs that are also readable essays",
    ],
  },
];
