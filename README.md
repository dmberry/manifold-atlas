...
| Grammar of Vectors | Does the rhetoric of "not X but Y" antithesis match the cosine geometry of X and Y? | Vector logic's native grammar / the synthetic dialectic |
